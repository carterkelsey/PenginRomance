...
// this helps us create possiblelocations for the website!
...
for (var i = 0; i< homes.length; i++){
    ...
    uniqueHomes.push(homes[i]);
        // Each time a new home appears it will add, with this loop, the number of times each home is listed is unknown. (reducing)
    }
} 
...
for(var i= 0; i< uniqueHomes.length; i++){
    ...
    //    filter throughh genders to find just females while reducing to 3 unique locations
}
...
// WHILE LOOP used to help create slider values

// set variable, variable for position (K) in the list
var k = 0;
...
// function uses filtered and reduceded information from all of our previous loops 
